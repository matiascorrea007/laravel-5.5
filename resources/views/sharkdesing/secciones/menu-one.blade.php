                    ...
                    <nav class="collapse collapsing navbar-collapse right-1024">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="parent current">
                          <a href="{!! URL::to('/') !!}" ><div class="main-menu-title">Home</div></a>
                        </li>
                        ...
                        <li class="parent megamenu">
                          <a href="{!! URL::to('/servicios') !!}" ><div class="main-menu-title">Servicios</div></a> 
                        </li>         
                        
                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="{!! URL::to('/portafolio') !!}" ><div class="main-menu-title">Portafolio</div></a>
                        </li>         
                        ...
                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="{!! URL::to('/preguntas') !!}" ><div class="main-menu-title">Preguntas?</div></a>
                        </li> 

                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="{!! URL::to('/nosotros') !!}" ><div class="main-menu-title">Nosotros</div></a>
                        </li> 

                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="{!! URL::to('/contacto') !!}" ><div class="main-menu-title">Contactenos</div></a>
                        </li> 
