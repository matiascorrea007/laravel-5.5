          ...
          <div class="container text-center">
            ...
            <div class="compar-slider-wrap">
              ...
              <div class="compar-slider"><img class="macbook" src="layout/material/img/macbook.png" alt="MacBook">
                <div class="cs-screen">
                  <figure class="cd-image-container"><img width="955" height="597" src="layout/material/img/diseno-soft/comparison_17.png" alt="">
...
<div class="wrap bg-primary ">
          ...
          <div class="row">
            <div class="col-md-5 text-center mt-6">
              <div class="img-phone-container">
                <img class="img-responsive wow zoomInDown animation-delay-3 index-1" src="layout\material\img\diseno-soft\1.jpg" style="visibility: visible; animation-name: zoomInDown;">
               </div>
            </div>
      ...
      <div class="wrap ms-hero-bg-dark  ms-bg-fixed" style="background-image: url(layout/material/img/app-bg.jpg);background-size: cover; background-position: center center;">

      <div class="container">
      <div class="color-white title">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-sm-pull-4">
          <div class="animation-box wow bounceIn animated" style="visibility: visible;">
            <img class="screen img-responsive" src="layout/material/img/diseno-soft/1.jpg" alt="" height="400" width="600"><br>
          </div>
          <div class="animation-box wow bounceIn animated" style="visibility: visible;">
            <img class="screen img-responsive" src="layout/material/img/diseno-soft/2.png" alt="" height="400" width="600"><br>
          </div>
          <div class="animation-box wow bounceIn animated" style="visibility: visible;">
            <img class="screen img-responsive" src="layout/material/img/diseno-soft/3.png" alt="" height="400" width="600">
          </div>
        </div>
