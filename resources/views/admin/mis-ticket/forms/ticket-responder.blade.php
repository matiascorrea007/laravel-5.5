...
<div class="panel panel-default">
		<div class="panel-heading">
   		 	<h3 class="panel-title">{{$comentario->user->nombre}}<div class="pull-right">
...
<div class="form-horizontal col-xs-12 col-sm-12 col-md-12">
	{!!Form::label('')!!}
	{!!Form::textarea ('comentario',null,['class'=>'col-xs-12 col-sm-12 col-md-12','id'=>'lfm','placeholder'=>'ingrese la observacion'])!!}
</div>
<br>
</div>
</div>
