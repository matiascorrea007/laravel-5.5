<html>
<head>
<title>Presupuesto Shark Informatica</title>
...
<body>
  ...
  @foreach($data as $presupuestos)
    @if($id == $presupuestos->id)
      ...
      <tbody>
        <tr>
          ...
          <td width="70%">
            ...
            <strong>Ciclo de facturación:</strong> 01/01/2013 to 01/02/2013<br>
        ...
        <tr>
          <td colspan="2">
            <div class="center-justified">
              <strong>Presupuesto a:</strong> {{ $presupuestos->cliente->nombre }}
              <strong>Importe del Presupuesto :</strong> {{ $presupuestos->total }}
            </div>
          </td>
        </tr>
      </tbody>
    ...
    <table width="100%" class="outline-table">
      <tbody>
        ...
        @foreach($transactions as $transaction)
         @if ($presupuestos->id == $transaction->presupuesto_id )
