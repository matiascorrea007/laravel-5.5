              ...
              <div class="container-m-30 clearfix"> 
                ...
                <div id="main-menu">
                  ...
                  <div class="navbar navbar-default" role="navigation">
                    ...
                    <nav class="collapse collapsing navbar-collapse right-1024">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="parent megamenu">
                          <a href="#services-link" ><div class="main-menu-title">Servicios</div></a> 
                        </li>         
                        
                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="#portafolio-link" ><div class="main-menu-title">Portafolio</div></a>
                        </li>         
                        ...
                        <!-- MENU ITEM -->
                        <li class="parent">
                          <a href="#contactenos" ><div class="main-menu-title">Contactenos</div></a>
                        </li> 
                    ...
                    <!-- cart -->
                        <li>
                             <li class="active"><a  href="{!! URL::to('/web-shopping-cart') !!}"><i class="glyphicon glyphicon-shopping-cart"></i> <span class="label label-danger">{{ $cartcount }}</span></a></li>
                        </li>
